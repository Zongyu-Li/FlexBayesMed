#' Variance of the centred two-piece student's t (or normal) distribution
#'
#' This function calculates the variance of the centred two-piece Student's t distribution
