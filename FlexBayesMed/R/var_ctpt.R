#' Variance of the Centred Two-Piece Student \emph{t} (or Normal) Distribution
#'
#' This function calculates the variance of the centred two-piece Student \emph{t} distribution
...
#' }
#'
#' When \code{nu = "normal"}, the variance is that of the centred two-piece normal distribution:
#' \deqn{
#'   \mathrm{Var}(\varepsilon \mid \gamma,\nu=\infty)
#'   =
#'     \bigl(\gamma^2 - 1 + \tfrac{1}{\gamma^2}\bigr)
...
#' }
#'
#' @return A numeric value giving the variance of the centred two-piece distribution.
#'
#' @examples
...
var_ctpt <- function(gamma, nu) {
  return(var_two_piece_student(gamma,nu))
}
