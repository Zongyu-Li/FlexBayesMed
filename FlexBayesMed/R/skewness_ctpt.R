#' Calculate the Fisher's Moment Coefficient of Skewness for the Centred Two-Piece Student \emph{t} (CTPT) Distribution
#'
#' This function calculates the skewness of the centred two-piece Student t (CTPT) distribution
...
#' @param nu Either:
#'   \itemize{
#'     \item A numeric value \code{> 3}, giving the degrees of freedom for the Student t
